				...
				Template.asString(
					outputOptions.strictModuleExceptionHandling
						? [
								...
								"try {",
								Template.indent([
									`modules[moduleId] && modules[moduleId].call(module.exports, module, module.exports, ${this.renderRequireFunctionForModule(
										hash,
										chunk,
										"moduleId"
									)});`,
...
class ResetRequireWebpackPlugin {
    apply(compiler) {
        compiler.hooks.thisCompilation.tap(
            "ResetRequireWebpackPlugin",
            compilation => {
                compilation.mainTemplate = new MainTemplate(
...
module.exports = ResetRequireWebpackPlugin;